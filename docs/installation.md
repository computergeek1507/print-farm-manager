...
| **Creality (K1 / K2 / Ender-3 V3 / Hi)** | IP address only | Printer touchscreen: **Settings → Network** shows the IP. No access code required for most K-series printers on the LAN. Port 9999 is used automatically. |
